...
- Eleven single-task agents in `.github/agents/` with `.agent.md` extension:
  ...
  - `notify-mcp.agent.md` — create/update MCP server tools and configuration
  - `notify-rag.agent.md` — create/update RAG pipeline (ingestion, chunking, embeddings, vector storage)
  - `notify-plugin.agent.md` — create/update plugin framework (hooks, rules, skills, agents)
  - `notify-ai-workflow.agent.md` — create/update AI workflow orchestration pipelines
  - `notify-monitoring.agent.md` — create/update monitoring, tracking, and observability
